...
exports.positions = /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var address,
      response,
      _args = arguments;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return axios.get("https://api.covalenthq.com/v1/1/address/".concat(address, "/balances_v2/?key=").concat(process.env.COVALENTHQ_API_KEY));
        ...
        case 4:
          ...
          response.data.data.items = response.data.data.items.filter(function (e) {
